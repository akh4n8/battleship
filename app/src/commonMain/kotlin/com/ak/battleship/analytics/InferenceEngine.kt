...
object InferenceEngine {
    ...
    fun calculateLiveWinState(
        ...
        val myActiveBlood = kotlin.math.max(0.0, myHits - (mySunks * 3.4)).toFloat()
        val oppActiveBlood = kotlin.math.max(0.0, oppHits - (oppSunks * 3.4)).toFloat()
        ...
        val firstBloodDecay = kotlin.math.max(0.0, 1.0 - (turnCount / 40.0)).toFloat()
