...
fun getPlayerColor(name: String): Color {
    return when (name) {
        "WatsonBot" -> Color(0xFF637E7C)
        "SherlockBot" -> Color(0xFF0469B2)
        "MycroftBot" -> Color(0xFFA8760F)
        "AdlerBot" -> Color(0xFF715673)
        "MoriartyBot" -> Color(0xFF8B0000)
        "HudsonBot" -> Color(0xFF2E7D32)
